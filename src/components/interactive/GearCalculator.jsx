...
const GearCalculator = React.memo(() => {
  ...
  // Export Report Function - Engineering Documentation
...
║         Gear Train Calculation V2.0                        ║
╚════════════════════════════════════════════════════════════╝

GENERATED: ${timestamp}
ANALYST: S. Yoga Vignesh
SOURCE: https://yogavignesh.me
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  Driver Gear (Pinion)
  ├─ Number of Teeth (T₁):    ${t1}
  └─ Input Speed (N₁):        ${n1} RPM

  Driven Gear
  └─ Number of Teeth (T₂):    ${t2}
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  Gear Ratio (GR)
  ├─ Formula:                 GR = T₂ ÷ T₁
  ├─ Calculation:             GR = ${t2} ÷ ${t1}
  └─ Result:                  ${results.gr}:1

  Output Speed (N₂)
  ├─ Formula:                 N₂ = N₁ ÷ GR
  ├─ Calculation:             N₂ = ${n1} ÷ ${results.gr}
  └─ Result:                  ${results.n2} RPM

  Torque Multiplication (TM)
  ├─ Formula:                 TM = GR
  ├─ Note:                    Assumes 100% efficiency
  └─ Result:                  ${results.tm}x
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  Gear Type:                  Spur Gear Train
  Configuration:              Simple Gear Pair
  Speed Relation:             Inverse to Gear Ratio
  Torque Relation:            Direct to Gear Ratio
  
  Performance Characteristics:
  • Speed Reduction:          ${((1 - (1/parseFloat(results.gr))) * 100).toFixed(1)}%
  • Torque Increase:          ${((parseFloat(results.tm) - 1) * 100).toFixed(1)}%
  • Mechanical Advantage:     ${results.gr}:1
...
This analysis is for educational and preliminary design purposes.
For production applications, conduct detailed engineering analysis
including:
  • Material selection and stress analysis
  • Gear tooth geometry and contact ratio
  • Lubrication and thermal considerations
  • Safety factors and load cycles
  • Manufacturing tolerances

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

Generated by: S. Yoga Vignesh
Mechanical Engineer & Full Stack Developer
NPR College of Engineering & Technology, Madurai

Portfolio: https://yogavignesh.me
LinkedIn: https://linkedin.com/in/yoga-vignesh-62733a377
GitHub: https://github.com/yogavignesh-engineer
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    ...
    element.download = `Gear_Analysis_${t1}T-${t2}T_${new Date().toISOString().split('T')[0]}.txt`;
        ...
        >
          ...
          >
            <h1 className="gear-h1">
              <span className="gear-icon">⚙️</span> Gear Train Calculator
            </h1>
          ...
          >
            <label>
              ...
              Driver Gear Teeth 
              <span className="variable">(T₁)</span>
            </label>
          ...
          <div className="gears-wrapper">
            ...
            >
              ...
              <div className="gear-label" style={{ position: 'absolute', bottom: '-40px', left: '50%', transform: 'translateX(-50%)' }}>
                ...
                <span className="label-rpm" style={{ color: '#a78bfa', fontSize: '12px' }}>{t1}T • {n1} RPM</span>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="gear-label" style={{ position: 'absolute', bottom: '-40px', left: '50%', transform: 'translateX(-50%)' }}>
                ...
                <span className="label-rpm" style={{ color: '#ffb88c', fontSize: '12px' }}>{t2}T • {results.n2} RPM</span>
              </div>
            </motion.div>
          </div>

...
lifespan by 300% and adapts to vibration frequency in realâ€‘time.
  ...
  },
  {
    ...
    subtitle: 'Rapid-prototyped water purification system.',
    
    // ENHANCED STORYTELLING
    story: {
      hook: "24-hour rapid prototyping challenge: Build a working industrial water filter with â‚¹5,000 budget. Everyone else used PVC pipes. I built a steel powerhouse.",
...
proving that active flow regulation increases filtration efficiency by 40%.
    ...
    process: [
      {
        phase: 'Analysis',
        action: 'Analyzed industrial water purification systems to isolate core principles.',
        duration: '2 hours',
